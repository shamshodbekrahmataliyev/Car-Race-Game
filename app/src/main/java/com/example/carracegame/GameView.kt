...
class GameView(var c : Context,var gameTask: GameTask):View(c)
{
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val d = resources.getDrawable(R.drawable.car_reds,null)
        ...
        for (i in otherCars.indices){
            try {
                ...
                val d2 = resources.getDrawable(R.drawable.car_yellows,null)
        ...
        canvas.drawText("Score : $speed", 380f, 80f,myPaint!!)
        invalidate()
